...
------------------------------------------------------------------------------------------------------------
\n              Newline (technically a line                         'Line1\nLine2'
                feed character: ASCII/Unicode 10)

\r              Carriage return (ASCII/Unicode 13)                  'Windows line 1\r\nWindows line 2'

\t              Tab (ASCII/Unicode 9)                               'Speed:\t60kph'

\'              Single quote (note that you can use                 'Don\'t'
                this even when not necessary)

\'              Double quote (note that you can use                 'Sam said \'hello\'.'
                this even when not necessary)
...
\uXXXX          Arbitrary Unicode code point (where +XXXX+          'De Morgan’s law: \u2310(P \u22c0 Q)
                is a hexadecimal code point)                         \u21D4 (\u2310P) \u22c1 (\u2310Q)'

\xXX            Latin-1 character (where +XX+ is a                  '\xc9p\xe9e is fun, but foil is more fun.'
                hexadecimal Latin-1 code point)
*/
